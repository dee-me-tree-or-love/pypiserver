...
- 147d406 prepend with PR title with chore
- 2f9e571 Fetch full history of the repo in the action
- 3fe84b2 add a debug call the collect commit info
- 8d821db Adding debug statement about compared versions
- 588fd6f Merge branch 'master' into chore-release-action
- e039f40 fix(typing-checks): fix small typing and lint errors in config.py (#421)
- ae5dd0b add forgotten NL command sprtr
- 575d95b add rc artifact folder to gitignore
- 30dc944 provide authentication token in gh action
- eb5deea add the PR creation step to the `rc action`
- 18c98c2 Improve comments in the script
- ec55084 Update bin/update_changelog.sh
- 20c1c48 progress updates
- 800d9cf commit and push
- c4b2b80 add small echo statement
- 82a44ff support macos and linux for sed
- d3dd38e add a listing of the workspace dir
- 9bd4ffa add different workspace dir
- cabc739 add git fetch
- 9820e60 add git status call to rc action
- ba0376b add exit on errors
- 257e008 add todo comment
- 6381215 add changelog edit to rc github action
- ce7389e Manage changelog automatically
- 3ac1d6c some small progress on CL automation
- 2943c45 first steps in RC action
